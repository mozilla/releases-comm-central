...
var {capServerTime, tagServerTime} = ChromeUtils.import("resource:///modules/ircServerTime.jsm");
...
function specMessages() {
  const kMessages = [
    {
      tags: getTags("@time=2011-10-19T16:40:51.620Z :Angel!angel@example.com PRIVMSG #test :Hello"),
  ...
  for (let m in kMessages) {
    ...
    if (kExpectedTimes[m] !== undefined) {
      ...
      equal(kExpectedTimes[m], tagMessage.message.time, "Time was parsed properly");
    }
  }
