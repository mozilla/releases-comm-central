...
use super::{PopulatedMsgDbHeader, SafeListener, SafeListenerWrapper, UnpopulatedMsgDbHeader};
...
impl SafeEwsMessageCreateListener {
    ...
    pub fn on_new_message_key(&self, hdr: &PopulatedMsgDbHeader) -> Result<(), nsresult> {
    ...
    ) -> Result<UnpopulatedMsgDbHeader, nsresult> {
    ...
    pub fn on_hdr_populated(&self, hdr: &PopulatedMsgDbHeader) -> Result<(), nsresult> {
