...
fn format_path(template_expressions: &TemplateExpressions) -> String {
    ...
    format!("{endpoint}/me/mailFolders/{mail_folder_id}/copy")
}
...
#[doc = "Invoke action copy\n\nCopy a mailfolder and its contents to another mailfolder.\n\nMore information available via [Microsoft documentation](https://learn.microsoft.com/graph/api/mailfolder-copy?view=graph-rest-1.0)."]
#[derive(Debug)]
