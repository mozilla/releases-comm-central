...
#![doc = "Provides operations to call the copy method.\n\nAuto-generated from [Microsoft OpenAPI metadata](https://github.com/microsoftgraph/msgraph-metadata/blob/master/openapi/v1.0/openapi.yaml) via `ms_graph_tb_extract openapi.yaml ms_graph_tb/`."]
...
fn format_path(template_expressions: &TemplateExpressions) -> String {
    ...
    format!("{endpoint}/me/messages/{message_id}/copy")
}
...
#[doc = "Invoke action copy\n\nCopy a message to a folder within the user's mailbox.\n\nMore information available via [Microsoft documentation](https://learn.microsoft.com/graph/api/message-copy?view=graph-rest-1.0)."]
#[derive(Debug)]
pub struct Post {
