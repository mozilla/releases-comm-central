 ...
 * calITimezoneService used for providing timezone objects to calendar
 * code.
 *
 * @implements {calITimezoneService}
 */
export const CalTimezoneService = new (class {
...
export { CalTimezoneService as timezoneService };
