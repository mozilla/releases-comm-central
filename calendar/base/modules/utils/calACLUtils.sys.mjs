...
export var acl = {
   ...
   * @returns {boolean} true if the calendar is writable.
   */
   ...
   *
   * @param {calIItemBase} aItem - The calendar item to check.
   * @returns {boolean} true if the item is modifiable.
   */
   ...
   *
   * @param {calIItemBase} aItem - The calendar item to check.
   * @returns {boolean} true if the invitation w.r.t. the item can be
   *   responded to.
   */
