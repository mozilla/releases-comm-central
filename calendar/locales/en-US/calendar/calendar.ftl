...
calendar-properties-color = Color:
calendar-properties-location = Location:
calendar-properties-refresh = Refresh Calendar:
calendar-properties-refresh-manual = Manually
calendar-properties-read-only = Read Only
calendar-properties-show-reminders = Show Reminders
calendar-properties-offline-support = Offline Support
calendar-properties-enable-calendar = Enable This Calendar
