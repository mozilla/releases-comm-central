...
set-password-reminder = Important: If you forget your secret key backup password, you will not be able to restore this backup later. Please record it in a safe location.
