...
key-type-pair = personal key (secret key and public key)
...
error-own-key-unusable =
    The key ID '{ $addr }' configured for the current identity does not yield a usable OpenPGP key.
