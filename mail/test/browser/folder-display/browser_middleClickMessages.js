 ...
 *
 * @param {boolean} loadPref - loadInBackground a message, true by default.
 ...
 * @param {boolean} shiftPressed - Whether the shift key has been pressed.
 */
async function _middle_click_with_nothing_selected_helper(
  loadPref,
  shiftPressed
) {
  ...
  await _middle_click_helper(loadPref, shiftPressed, 1, 1);
 ...
 * @param {boolean} shiftPressed - Whether the shift key has been pressed.
 */
async function _middle_click_with_one_thing_selected_helper(
  loadPref,
  shiftPressed
) {
  await be_in_folder(folder);
...
async function _middle_click_with_many_things_selected_helper(
  ...
  await _middle_click_helper(loadPref, shiftPressed, 6, 1);
 ...
 * @param {boolean} shiftPressed - Whether the shift key has been pressed.
 */
async function _middle_click_on_existing_single_selection_helper(
  loadPref,
  shiftPressed
) {
  await be_in_folder(folder);
  ...
  await _middle_click_helper(loadPref, shiftPressed, 3, 1);
...
async function _middle_click_on_existing_multi_selection_helper(
  ...
  await _middle_click_helper(loadPref, shiftPressed, 6, 4);
 ...
 * @param {boolean} shiftPressed - Whether the shift key has been pressed.
 */
async function _middle_click_on_expanded_thread_root_helper(
  loadPref,
  shiftPressed
) {
 ...
 * @param {boolean} shiftPressed - Whether the shift key has been pressed.
 */
async function _middle_click_on_collapsed_thread_root_helper(
  loadPref,
  shiftPressed
) {
  await be_in_folder(threadedFolder);
...
add_task(
  async function test_middle_click_interactions_with_different_openMessageBehaviour_preferences() {
    ...
    const loadPref = true;
    set_context_menu_background_tabs(loadPref);
    ...
    for (
      ...
      // await _middle_click_with_nothing_selected_helper(loadPref, shiftPressed);

      // one message selected
      await _middle_click_with_one_thing_selected_helper(
        loadPref,
        shiftPressed
      );
      ...
      await _middle_click_on_collapsed_thread_root_helper(
        loadPref,
        shiftPressed
      );

      // expanded thread root
      await _middle_click_on_expanded_thread_root_helper(
        loadPref,
        shiftPressed
      );
    }
