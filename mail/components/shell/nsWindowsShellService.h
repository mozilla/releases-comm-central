...
#ifndef COMM_MAIL_COMPONENTS_SHELL_NSWINDOWSSHELLSERVICE_H_
#define COMM_MAIL_COMPONENTS_SHELL_NSWINDOWSSHELLSERVICE_H_
...
#endif  // COMM_MAIL_COMPONENTS_SHELL_NSWINDOWSSHELLSERVICE_H_
