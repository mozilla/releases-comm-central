...
function CompFields2Recipients(msgCompFields) {
  if (msgCompFields) {
    ...
    if (typeof msgCompFields.replyTo == "string") {
      ...
      let msgReplyTo = MailServices.headerParser.parseDecodedHeader(
    ...
    if (typeof msgCompFields.to == "string") {
      ...
      let msgTo = MailServices.headerParser.parseDecodedHeader(
        msgCompFields.to
      );
      if (msgTo.length) {
    ...
    if (typeof msgCompFields.cc == "string") {
      ...
      let msgCC = MailServices.headerParser.parseDecodedHeader(
        msgCompFields.cc
      );
      if (msgCC.length) {
    ...
    if (typeof msgCompFields.bcc == "string") {
      ...
      let msgBCC = MailServices.headerParser.parseDecodedHeader(
        msgCompFields.bcc
      );
      if (msgBCC.length) {
    ...
    if (typeof msgCompFields.followupTo == "string") {
      ...
      let msgFollowupTo = MailServices.headerParser.parseDecodedHeader(
