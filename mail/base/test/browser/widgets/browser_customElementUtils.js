...
add_setup(async () => {
  const tab = tabmail.openTab("contentTab", {
    url: "chrome://mochitests/content/browser/comm/mail/base/test/browser/widgets/files/customElementUtils.html",
  });
  browser = tab.browser;
...
add_task(async function test_defineLazyCustomElement() {
  ...
  win.callDefineElement(
    "test-element",
    "chrome://mochitests/content/browser/comm/mail/base/test/browser/widgets/files/test-element.mjs"
  );
  ...
  await win.callDefineElement(
    "test-element",
    "chrome://mochitests/content/browser/comm/mail/base/test/browser/widgets/files/other-element.mjs"
  );
...
add_task(async function test_defineLazyCustomElement_overrideExisting() {
  ...
  await win.callDefineElement(
    "existing-element",
    "chrome://mochitests/content/browser/comm/mail/base/test/browser/widgets/files/override-element.mjs"
  );
