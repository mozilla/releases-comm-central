...
#ifndef COMM_MAILNEWS_LOCAL_SRC_NSMAILBOXPROTOCOL_H_
#define COMM_MAILNEWS_LOCAL_SRC_NSMAILBOXPROTOCOL_H_
...
#endif  // COMM_MAILNEWS_LOCAL_SRC_NSMAILBOXPROTOCOL_H_
