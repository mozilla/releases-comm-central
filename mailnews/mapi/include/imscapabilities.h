#ifndef COMM_MAILNEWS_MAPI_INCLUDE_IMSCAPABILITIES_H_
#define COMM_MAILNEWS_MAPI_INCLUDE_IMSCAPABILITIES_H_
...
#endif  // COMM_MAILNEWS_MAPI_INCLUDE_IMSCAPABILITIES_H_
