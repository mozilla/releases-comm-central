...
#ifndef COMM_MAILNEWS_SEARCH_SRC_NSMSGRESULTELEMENT_H_
#define COMM_MAILNEWS_SEARCH_SRC_NSMSGRESULTELEMENT_H_
...
#endif  // COMM_MAILNEWS_SEARCH_SRC_NSMSGRESULTELEMENT_H_
