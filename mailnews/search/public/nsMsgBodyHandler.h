...
#ifndef COMM_MAILNEWS_SEARCH_PUBLIC_NSMSGBODYHANDLER_H_
#define COMM_MAILNEWS_SEARCH_PUBLIC_NSMSGBODYHANDLER_H_
...
#endif  // COMM_MAILNEWS_SEARCH_PUBLIC_NSMSGBODYHANDLER_H_
