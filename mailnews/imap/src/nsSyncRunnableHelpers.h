...
#ifndef COMM_MAILNEWS_IMAP_SRC_NSSYNCRUNNABLEHELPERS_H_
#define COMM_MAILNEWS_IMAP_SRC_NSSYNCRUNNABLEHELPERS_H_
...
#endif  // COMM_MAILNEWS_IMAP_SRC_NSSYNCRUNNABLEHELPERS_H_
