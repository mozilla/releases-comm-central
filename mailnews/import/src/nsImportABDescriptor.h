...
#ifndef COMM_MAILNEWS_IMPORT_SRC_NSIMPORTABDESCRIPTOR_H_
#define COMM_MAILNEWS_IMPORT_SRC_NSIMPORTABDESCRIPTOR_H_
...
#endif  // COMM_MAILNEWS_IMPORT_SRC_NSIMPORTABDESCRIPTOR_H_
