...
#ifndef COMM_MAILNEWS_IMPORT_SRC_NSIMPORTMAILBOXDESCRIPTOR_H_
#define COMM_MAILNEWS_IMPORT_SRC_NSIMPORTMAILBOXDESCRIPTOR_H_
...
#endif  // COMM_MAILNEWS_IMPORT_SRC_NSIMPORTMAILBOXDESCRIPTOR_H_
