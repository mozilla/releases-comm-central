...
#ifndef COMM_MAILNEWS_MIME_SRC_MIMEI_H_
#define COMM_MAILNEWS_MIME_SRC_MIMEI_H_
...
extern MimeObject* mime_create(const char* content_type, MimeHeaders* hdrs,
                               MimeDisplayOptions* opts,
                               bool forceInline = false, int32_t partDepth = 0,
                               MimeObject* smimeParentObj = nullptr);
...
#endif  // COMM_MAILNEWS_MIME_SRC_MIMEI_H_
