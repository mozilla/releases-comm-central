...
#ifndef COMM_MAILNEWS_MIME_SRC_MIMETEXTHTMLPARSED_H_
#define COMM_MAILNEWS_MIME_SRC_MIMETEXTHTMLPARSED_H_
...
#endif  // COMM_MAILNEWS_MIME_SRC_MIMETEXTHTMLPARSED_H_
