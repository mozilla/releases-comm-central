...
#ifndef COMM_MAILNEWS_MIME_PUBLIC_MIMEHEADERPARSER_H_
#define COMM_MAILNEWS_MIME_PUBLIC_MIMEHEADERPARSER_H_
...
#endif  // COMM_MAILNEWS_MIME_PUBLIC_MIMEHEADERPARSER_H_
