...
#ifndef COMM_MAILNEWS_DB_MORK_MORKSEARCHROWCURSOR_H_
#define COMM_MAILNEWS_DB_MORK_MORKSEARCHROWCURSOR_H_
...
#endif  // COMM_MAILNEWS_DB_MORK_MORKSEARCHROWCURSOR_H_
