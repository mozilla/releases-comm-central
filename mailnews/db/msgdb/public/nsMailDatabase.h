...
#ifndef COMM_MAILNEWS_DB_MSGDB_PUBLIC_NSMAILDATABASE_H_
#define COMM_MAILNEWS_DB_MSGDB_PUBLIC_NSMAILDATABASE_H_
...
#endif  // COMM_MAILNEWS_DB_MSGDB_PUBLIC_NSMAILDATABASE_H_
