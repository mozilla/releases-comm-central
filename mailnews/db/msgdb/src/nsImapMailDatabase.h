...
#ifndef COMM_MAILNEWS_DB_MSGDB_SRC_NSIMAPMAILDATABASE_H_
#define COMM_MAILNEWS_DB_MSGDB_SRC_NSIMAPMAILDATABASE_H_
...
#endif  // COMM_MAILNEWS_DB_MSGDB_SRC_NSIMAPMAILDATABASE_H_
