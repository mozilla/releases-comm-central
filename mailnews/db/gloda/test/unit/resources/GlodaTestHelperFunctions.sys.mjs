 ...
 *  hangs.
 */
export async function waitForIndexingHang() {
  await hangPromise;
}
 ...
 */
export function configureGlodaIndexing(aArgs) {
 ...
 */
export async function resumeFromSimulatedHang(aJustResumeExecution) {
 ...
 */
export async function permuteMessages(aScenarioMaker, messageInjection) {
