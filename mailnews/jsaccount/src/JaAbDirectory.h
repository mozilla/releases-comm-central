...
#ifndef COMM_MAILNEWS_JSACCOUNT_SRC_JAABDIRECTORY_H_
#define COMM_MAILNEWS_JSACCOUNT_SRC_JAABDIRECTORY_H_
...
#endif  // COMM_MAILNEWS_JSACCOUNT_SRC_JAABDIRECTORY_H_
