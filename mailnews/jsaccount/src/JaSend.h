...
class JaBaseCppSend : public nsMsgComposeAndSend, public nsIInterfaceRequestor {
 public:
...
class JaCppSendDelegator : public JaBaseCppSend, public msgIOverride {
 public:
  NS_DECL_ISUPPORTS_INHERITED
  ...
  NS_FORWARD_NSIMSGOPERATIONLISTENER(
      DELEGATE_JS(
          mJsIMsgOperationListener, mMethods,
